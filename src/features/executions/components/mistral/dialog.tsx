    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Powered by OpenRouter · <code className="text-xs">{MODEL}</code> (a
            community Mistral fine-tune, not Mistral AI's own API)
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Sets the AI behavior. Supports Handlebars variables.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      placeholder="Summarize: {{myData.text}}"
                      className="min-h-[120px] font-mono text-sm"
                      {...field}
                    />
                  </FormControl>
                  <FormDescription>
                    The prompt to send. Supports Handlebars variables.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
